...
public class PathToAudio {
    ...
    private String pathLanguageCiklo = pathToAudio + "Ciklo_DM/";
    private String pathLanguageNomernoi = pathToAudio + "Nomernoi_DM";
    private String pathLanguageRitmo = pathToAudio + "Ritmo_DM";
    private String pathLanguageR100 = pathToAudio + "R100_DM";
    private String pathLanguageRadasteid = pathToAudio + "Radasteid_DM";
