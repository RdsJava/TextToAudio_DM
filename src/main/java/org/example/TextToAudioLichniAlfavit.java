...
public class TextToAudioLichniAlfavit {
    public void textToAudioLichniAlfavit(String text) throws IOException {

        MapLichniiCiklo map = new MapLichniiCiklo();
        String checkEndLanguage = "оль";
        String checkLanguagePath = "Ciklo_DM/";
        String endFileName = " ЛичАлфОль ";
        ...
        string = "<" + string; //Фраза "Начало переизлучения"
        string = string + ">"; // Фраза "Конец переизлучения"
